...
describe('TasksService', () => {
  ...
  describe('create task', () => {
    it('creates task successfully', async () => {
      ...
      const result = await tasksService.createTask({}, mockUser);
      expect(taskRepository.createTask).toHaveBeenCalledWith({}, mockUser);
      expect(result).toEqual(mockTask);
    });
  });

  describe('delete task', () => {
    it('calls taskrepository.deleteTask() and deletes the task', async () => {
